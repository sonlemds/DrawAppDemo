...
class _$Stroke extends Stroke {
  ...
  factory _$Stroke([void Function(StrokeBuilder)? updates]) =>
      (new StrokeBuilder()..update(updates))._build();

  _$Stroke._(
      {required this.locations, required this.strokeWidth, required this.color})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(locations, r'Stroke', 'locations');
    BuiltValueNullFieldError.checkNotNull(
        strokeWidth, r'Stroke', 'strokeWidth');
    BuiltValueNullFieldError.checkNotNull(color, r'Stroke', 'color');
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, strokeWidth.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Stroke')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Stroke', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
